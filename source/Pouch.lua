...
local STORABLE_ALWAYS <const> = {
  ...
  -- Pickups
  [ENT_TYPE.ITEM_PICKUP_12BAG] = true,
  [ENT_TYPE.ITEM_PICKUP_24BAG] = true,
  [ENT_TYPE.ITEM_PICKUP_ANKH] = true,
  [ENT_TYPE.ITEM_PICKUP_BOMBBAG] = true,
  [ENT_TYPE.ITEM_PICKUP_BOMBBOX] = true,
  [ENT_TYPE.ITEM_PICKUP_CLIMBINGGLOVES] = true,
  [ENT_TYPE.ITEM_PICKUP_CLOVER] = true,
  [ENT_TYPE.ITEM_PICKUP_COMPASS] = true,
  [ENT_TYPE.ITEM_PICKUP_COOKEDTURKEY] = true,
  [ENT_TYPE.ITEM_PICKUP_CROWN] = true,
  [ENT_TYPE.ITEM_PICKUP_EGGPLANTCROWN] = true,
  [ENT_TYPE.ITEM_PICKUP_ELIXIR] = true,
  [ENT_TYPE.ITEM_PICKUP_GIANTFOOD] = true,
  [ENT_TYPE.ITEM_PICKUP_HEDJET] = true,
  [ENT_TYPE.ITEM_PICKUP_JOURNAL] = true,
  [ENT_TYPE.ITEM_PICKUP_KAPALA] = true,
  [ENT_TYPE.ITEM_PICKUP_PARACHUTE] = true,
  [ENT_TYPE.ITEM_PICKUP_PASTE] = true,
  [ENT_TYPE.ITEM_PICKUP_PITCHERSMITT] = true,
  [ENT_TYPE.ITEM_PICKUP_PLAYERBAG] = true,
  [ENT_TYPE.ITEM_PICKUP_ROPE] = true,
  [ENT_TYPE.ITEM_PICKUP_ROPEPILE] = true,
  [ENT_TYPE.ITEM_PICKUP_ROYALJELLY] = true,
  [ENT_TYPE.ITEM_PICKUP_SEEDEDRUNSUNLOCKER] = true,
  [ENT_TYPE.ITEM_PICKUP_SKELETON_KEY] = true,
  [ENT_TYPE.ITEM_PICKUP_SPECIALCOMPASS] = true,
  [ENT_TYPE.ITEM_PICKUP_SPECTACLES] = true,
  [ENT_TYPE.ITEM_PICKUP_SPIKESHOES] = true,
  [ENT_TYPE.ITEM_PICKUP_SPRINGSHOES] = true,
  [ENT_TYPE.ITEM_PICKUP_TABLETOFDESTINY] = true,
  [ENT_TYPE.ITEM_PICKUP_TORNJOURNALPAGE] = true,
  [ENT_TYPE.ITEM_PICKUP_TRUECROWN] = true,
  [ENT_TYPE.ITEM_PICKUP_UDJATEYE] = true,
...
function Pouch:store(player_uid, held_uid, slot_index)
  ...
  if #self.slots >= self.max_size then
    self:retrieve(player_uid, slot_index)
  end
  table.insert(self.slots, slot_index, metadata)
end
